  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card title="Sheetal is Nisha" icon={<AceternityIcon title = "Phase 1"/>}
        ...
        <Card title="Nisha is Munni" icon={<AceternityIcon title="Phase 2"/>}
        description = "blah blah"> 
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Munni is Aditi" icon={<AceternityIcon  title="Phase 3"/>}
        description = "blah blah"> 
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 lg:h-[35rem]  relative rounded-3xl sm:h-[40vh] sm:w-[80vw] "
      style={{
        //   add these two
